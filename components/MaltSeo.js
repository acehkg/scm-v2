...
const MaltSeo = ({ meta }) => {
  return (
    <Head>
      ...
      <meta
        name='description'
        content={`Grown in ${meta.grown}, harvested ${meta.harvested} and malted ${meta.malted}`}
      />
      <meta property='og:type' content='website' />
      <meta name='og:title' property='og:title' content={meta.name} />
      <meta
        name='og:description'
